...
function renderVandaag(datumISO, p) {
  ...
  if (!dagActs.length) { el.innerHTML = '<div class="empty-state"><i data-lucide="sun" class="empty-icon"></i><p>Geen activiteiten vandaag</p><a href="agenda.html?nieuw=1" class="btn btn-secondary btn-sm" style="margin-top:10px;display:inline-flex;">Plan activiteit →</a></div>'; return; }
